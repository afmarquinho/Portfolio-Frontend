              ...
              <section className="col-12 col-lg-5 col-xl-6 ">
                <div className="article article1 my-5">
                  ...
                  <p className="content text-justify">
                    I have a solid foundation in HTML, CSS, and JavaScript, and
                    I am eager to apply my skills to your project. I can create
                ...
                <div className="article article2 my-5">
                  ...
                  <p className="text-justify">
                    ...
                    and I'm familiar with popular front-end frameworks such as
                    React. I stay up to date with industry trends and best
                    practices, I am also dedicated to improving my skills and
                    seeking feedback from more experienced developers.
                  </p>
                  <p className="text-justify">
                    I'm able to work closely with designers, back-end
                    developers, and other stakeholders on web development
                    projects.work well in a team and am passionate about web
                    development.
                  </p>
